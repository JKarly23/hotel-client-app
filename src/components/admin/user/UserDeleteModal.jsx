...
import { deleteUser } from "../../../feautere/auth/authSlice";
import { AuthService } from "../../../services/AuthService";

const userService = new AuthService();

const UserDeleteModal = ({ isOpen, onClose, user }) => {
  ...
  const onDelete = async (id) => {
    try {
      ...
      setFeedbackMessage("Usuario eliminado");
    } catch (error) {
  ...
  return (
    <Modal isOpen={isOpen} onClose={onClose}>
      ...
      <div className="flex flex-col items-center">
        {!feedbackMessage && (
          <>
            <h2 className="text-xl font-bold text-red-600 mb-4">¿Eliminar usuario?</h2>

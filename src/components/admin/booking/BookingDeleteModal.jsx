...
import { deleteBooking } from "../../../feautere/booking/bookingsSlice";

const bookingService = new BookingService();

const BookingDeleteModal = ({ isOpen, onClose, booking }) => {
  ...
  const onDelete = async (id) => {
    try {
      ...
      setFeedbackMessage("Reserva eliminada");
    } catch (error) {
  ...
  return (
    <Modal isOpen={isOpen} onClose={onClose}>
      ...
      <div className="flex flex-col items-center">
        {!feedbackMessage && (
          <>
            <h2 className="text-xl font-bold text-red-600 mb-4">¿Eliminar reserva?</h2>

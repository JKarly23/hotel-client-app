        ...
        <footer className="bg-gray-900 text-white py-12">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                    <div>
                        <h3 className="text-xl font-semibold mb-4">Hotel Paradise</h3>
                        <p className="text-gray-400">
                            Ofreciendo experiencias inolvidables desde 2010.
                        </p>
                    </div>
                    <div>
                        ...
                        <ul className="space-y-2">
                            ...
                            <li><a href="#rooms" className="text-gray-400 hover:text-white transition">Habitaciones</a></li>
                ...
                <div className="mt-12 border-t border-gray-800 pt-8 text-center text-sm text-gray-400">
                    <p>© 2023 Hotel Paradise. Todos los derechos reservados.</p>
                </div>
            </div>
        </footer>
    )
